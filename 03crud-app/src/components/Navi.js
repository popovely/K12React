...
class Navi extends Component {
    render() {
        ...
        /*
            ...
            li태그를 출력한다.
            이 때 warning이 뜨는데, 중복되지 않는 key prop를 추가해야 한다는 내용이다.
            리엑트의 권고사항이므로 li태그에 key속성을 추가하여 중복되지 않는 값을 가지도록 처리해준다.
        */
        /*
            자식은 부모쪽으로 데이터를 전달할 때 event를 이용한다. 
            data-id라는 속성은 event를 통해 전달될 때
            "이벤트객체.target.dataset.id"를 통해 그 값을 얻어올 수 있다.
        */
        while (i < data.length) {
